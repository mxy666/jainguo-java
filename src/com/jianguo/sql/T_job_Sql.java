...
public class T_job_Sql {
	...
	public static List<T_job_Bean> select_all(String city_id,String status,String count){
		List<T_job_Bean> list=new ArrayList<T_job_Bean>();
		ResultSet rs=null;
		Connection conn=DButil.getCon();
		String sql = "select * from t_job where city_id=? and status=? and is_model=0 order by id desc limit "+count+",80";
		PreparedStatement psmt = DButil.getPstm(conn, sql);
		try {
...
//			psmt.setString(2,status);
	...
	public static List<T_job_Bean> select_hot(String hot,String city_id,String date,String count){
		...
		ResultSet rs=null;
		Connection conn=DButil.getCon();
		String sql = "select * from t_job where hot=? and city_id=? and is_model=0 and (status=0 or status=2) order by id desc limit "+count+",10";
		PreparedStatement psmt = DButil.getPstm(conn, sql);
		try {
...
//			psmt.setString(4,date2);
	...
	public static List<T_job_Bean> select_lvxing(String hot,String date,String count){
		...
		ResultSet rs=null;
		Connection conn=DButil.getCon();
		String sql = "select * from t_job where hot=? and is_model=0 order by id desc limit "+count+",10";
		PreparedStatement psmt = DButil.getPstm(conn, sql);
		try {
			psmt.setString(1,hot);
//			psmt.setString(3,date);
...
//			psmt.setString(4,date2);
	...
	public static List<T_job_Bean> select_filter0(String city_id,String type_id,String area_id,String date,String date2,String count){
		...
		ResultSet rs=null;
		Connection conn=DButil.getCon();
		String sql = "select * from t_job where city_id=? and (type_id=? or area_id=?) and is_model=0 and status=0 and hot!=3 order by id desc limit "+count+",10";
		PreparedStatement psmt = DButil.getPstm(conn, sql);
		try {
			psmt.setString(1,city_id);
...
//			psmt.setString(5,date2);
	...
	public static List<T_job_Bean> select_filter000(String city_id,String type_id,String area_id,String date,String date2,String count){
		...
		ResultSet rs=null;
		Connection conn=DButil.getCon();
		String sql = "select * from t_job where city_id=? and (type_id=? and area_id=?) and is_model=0 and status=0 and hot!=3 order by id desc limit "+count+",10";
		PreparedStatement psmt = DButil.getPstm(conn, sql);
		try {
			psmt.setString(1,city_id);
			psmt.setString(2,type_id);
...
//			psmt.setString(5,date2);
	...
	public static List<T_job_Bean> select_filter00(String city_id,String date,String date2,String count){
		...
		ResultSet rs=null;
		Connection conn=DButil.getCon();
		String sql = "select * from t_job where city_id=? and is_model=0 and status=0 and hot!=3 order by id desc limit "+count+",10";
		PreparedStatement psmt = DButil.getPstm(conn, sql);
		try {
			psmt.setString(1,city_id);
