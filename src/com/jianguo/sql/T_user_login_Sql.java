...
public class T_user_login_Sql {
	...
	//用户注册（手机号）
	public static int insert_tel(String tel,String password,String power,String status,String resume){
		   int num=0;
		   Connection conn=DButil.getCon();
		   String sql="insert into t_user_login(tel,password,power,status,resume) values(?,?,?,?,?)";
